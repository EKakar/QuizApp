...
class ui:
    ...
    def previewQuestion(self, index):
        ...
        tk.Label(self.leftFrame, text="True Answer:" + QuestionArray[index].optionTexts[0]).place(x=100, y=400,
                                                                                                  width=400, height=50)
        ...
        btn = tk.Button(self.leftFrame, text="Delete Question",
                        command=lambda: [self.removeQuestion(index), self.updateRightBuffer(), self.clearLeftFrame(),
                                         self.loginScreen()])
    ...
    def questingAddScreen(self):
        ...
        self.backButton = tk.Button(self.leftFrame, text="Back",
                                    command=lambda: [self.clearLeftFrame(), self.loginScreen()])
    ...
    def studentScreen(self):
        ...
        tk.Button(self.leftFrame, text="Back", command=lambda: [self.clearLeftFrame(), self.loginScreen()]).place(x=200,
                                                                                                                  y=400,
                                                                                                                  width=200,
                                                                                                                  height=50)
    ...
    def finishExam(self):
        ...
        self.clearLeftFrame()
        tk.Label(self.leftFrame, text="Number of true answer: " + str(correctCount), justify="center").place(x=0, y=100,
                                                                                                             width=600,
                                                                                                             height=25)
        tk.Label(self.leftFrame, text="Number of wrong answer: " + str(wrongCount), justify="center").place(x=0, y=200,
                                                                                                            width=600,
                                                                                                            height=25)
        tk.Label(self.leftFrame, text="Number of empty question: " + str(emptyCount), justify="center").place(x=0,
                                                                                                              y=300,
                                                                                                              width=600,
                                                                                                              height=25)
